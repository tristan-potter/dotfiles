...
commands =
  ...
  playing: "false" # cmus-remote --query | grep artist\  | awk '{print $3}'"
...
render: ( ) ->
  ...
  <div class="bar" id="bottom">
    ...
    <div class="widg">
      ...
      <i class="fa fa-window-maximize desk" id="desk5"></i>
      <i class="fa fa-window-maximize desk" id="desk6"></i>
    </div>
    </div>
...
afterRender: (domEl) ->
    ...
    $(domEl).on 'click', '#messages', => @run "open /Applications/Caprine.app"
